...
const customcolor1 = Color(0xFF18181B);

CustomColors lightCustomColors = const CustomColors(
  sourceCustomcolor1: Color(0xFF18181B),
  customcolor1: Color(0xFF4958A9),
  onCustomcolor1: Color(0xFFFFFFFF),
  customcolor1Container: Color(0xFFDEE0FF),
  onCustomcolor1Container: Color(0xFF00105B),
);

CustomColors darkCustomColors = const CustomColors(
  sourceCustomcolor1: Color(0xFF18181B),
  customcolor1: Color(0xFFBAC3FF),
  onCustomcolor1: Color(0xFF172778),
  customcolor1Container: Color(0xFF313F90),
  onCustomcolor1Container: Color(0xFFDEE0FF),
);
